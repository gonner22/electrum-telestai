...
from electrum_tls.wallet import Wallet, create_new_wallet
from electrum_tls.wallet_db import WalletDB
from electrum_tls.commands import Commands
from electrum_tls.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-tls/testnet as datadir
