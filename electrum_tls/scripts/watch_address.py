...
from electrum_tls.util import print_msg, create_and_start_event_loop
from electrum_tls.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <telestai_address>")
    sys.exit(1)
