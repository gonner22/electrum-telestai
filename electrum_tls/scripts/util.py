...
from electrum_tls.network import parse_servers
from collections import defaultdict

# electrum_tls.util.set_verbosity(1)
...
def get_peers():
    ...
    if server is None:
        print("You need to set a secure server, for example (for mainnet): 'electrum-tls setconfig server helicarrier.bauerj.eu:50002:s'")
        return []
