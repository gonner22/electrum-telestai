...
from electrum_tls.bitcoin import TOTAL_COIN_SUPPLY_LIMIT_IN_BTC
from electrum_tls.i18n import set_language, languages
from electrum_tls.logging import get_logger
from electrum_tls.util import base_unit_name_to_decimal_point
...
class QEConfig(AuthMixin, QObject):
    ...
    def btcAmountRegex(self):
        ...
        max_digits_before_dp = (
            ...
            + (base_unit_name_to_decimal_point("TLS") - decimal_point))
