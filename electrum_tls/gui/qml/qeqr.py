...
from electrum_tls.qrreader import get_qr_reader
from electrum_tls.i18n import _
from electrum_tls.util import profiler, get_asyncio_loop
...
class QEQRImageProvider(QQuickImageProvider):
    ...
    def requestImage(self, qstr, size):
        ...
        if uri.scheme and uri.scheme in ['telestai', 'lightning']:
