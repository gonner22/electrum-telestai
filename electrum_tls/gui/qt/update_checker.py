...
from electrum_tls import version
from electrum_tls import constants
from electrum_tls import ecc
from electrum_tls.i18n import _
from electrum_tls.util import make_aiohttp_session
from electrum_tls.logging import Logger
from electrum_tls.network import Network
from electrum_tls._vendor.distutils.version import StrictVersion


class UpdateCheck(QDialog, Logger):
    url = "https://telestai.io/version"
    download_url = "https://www.telestai.io/telestai-electrum-wallet/"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Electrum-TLS - ' + _('Update Check'))
