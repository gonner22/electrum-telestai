...
from electrum_tls.util import InvoiceError
from electrum_tls.invoices import pr_expiration_values
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def update_view_button(self):
        ...
        if i == 0:
            icon, text = read_QIcon("link.png"), _('Telestai URI')
        elif i == 1:
            icon, text = read_QIcon("telestai.png"), _('Address')
        elif i == 2:
