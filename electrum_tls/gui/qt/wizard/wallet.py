...
from electrum_tls.bip32 import is_bip32_derivation, BIP32Node, normalize_bip32_derivation, xpub_type
from electrum_tls.daemon import Daemon
from electrum_tls.i18n import _
from electrum_tls.keystore import bip44_derivation, bip39_to_seed, purpose48_derivation, ScriptTypeNotSupported
from electrum_tls.plugin import run_hook, HardwarePluginLibraryUnavailable
from electrum_tls.storage import StorageReadWriteError
from electrum_tls.util import WalletFileException, get_new_wallet_name, UserFacingException, InvalidPassword
from electrum_tls.util import is_subpath
from electrum_tls.wallet import wallet_types
from .wizard import QEAbstractWizard, WizardComponent
from electrum_tls.logging import get_logger, Logger
from electrum_tls import WalletStorage, mnemonic, keystore
from electrum_tls.wallet_db import WalletDB
from electrum_tls.wizard import NewWalletWizard

from electrum_tls.gui.qt.bip39_recovery_dialog import Bip39RecoveryDialog
from electrum_tls.gui.qt.password_dialog import PasswordLayout, PW_NEW, MSG_ENTER_PASSWORD, PasswordLayoutForHW
from electrum_tls.gui.qt.seed_dialog import SeedLayout, MSG_PASSPHRASE_WARN_ISSUE4566, KeysLayout
from electrum_tls.gui.qt.util import (PasswordLineEdit, char_width_in_lineedit, WWLabel, InfoButton, font_height,
...
if TYPE_CHECKING:
    ...
    from electrum_tls.plugin import Plugins
    from electrum_tls.daemon import Daemon
    from electrum_tls.gui.qt import QElectrumApplication

WIF_HELP_TEXT = (_('WIF keys are typed in Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
                 'p2pkh:KxZcY47uGp9a...       \t-> FhnUDbQmu...\n' +
                 'p2wpkh-p2sh:KxZcY47uGp9a... \t-> 3NhNeZQXF...\n' +
                 'p2wpkh:KxZcY47uGp9a...      \t-> tls1q3fjf...')
...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ('imported',  _('Import Telestai addresses or private keys')),
        ]
...
class WCImport(WalletWizardComponent):
    def __init__(self, parent, wizard):
        WalletWizardComponent.__init__(self, parent, wizard, title=_('Import Telestai Addresses or Private Keys'))
        message = _(
            'Enter a list of Telestai addresses (this will create a watching-only wallet), or a list of private keys.')
