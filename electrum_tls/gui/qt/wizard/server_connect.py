...
from electrum_tls.wizard import ServerConnectWizard
from electrum_tls.gui.qt.network_dialog import ProxyWidget, ServerWidget
from electrum_tls.gui.qt.util import icon_path
...
class WCWelcome(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Electrum Telestai Wallet')
