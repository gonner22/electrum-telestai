...
from electrum_tls import WalletStorage, Wallet
from electrum_tls.wallet import Abstract_Wallet
from electrum_tls.wallet_db import WalletDB
from electrum_tls.util import format_satoshis, EventListener, event_listener
from electrum_tls.bitcoin import is_address, COIN
from electrum_tls.transaction import PartialTxOutput
from electrum_tls.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Telestai address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-tls setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-tls setconfig' to change your settings")
        return True
