# ----------------------------------------------------------------------------------
# Electrum-TLS plugin for the Digital Bitbox hardware wallet by Shift Devices AG
# digitalbitbox.com
#
...
from electrum_tls.crypto import sha256d, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_tls.bitcoin import public_key_to_p2pkh, usermessage_magic
from electrum_tls.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_tls.bip32 import normalize_bip32_derivation
...
from electrum_tls.transaction import Transaction, PartialTransaction, PartialTxInput, Sighash
from electrum_tls.i18n import _
from electrum_tls.keystore import Hardware_KeyStore
from electrum_tls.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_tls.network import Network
from electrum_tls.logging import get_logger
from electrum_tls.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def check_device_dialog(self):
        ...
        if not self.setupRunning:
            self.isInitialized = True # Wallet exists. Electrum-TLS code later checks if the device matches the wallet
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Electrum-TLS-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
