...
from electrum_tls.util import bfh, UserCancelled, UserFacingException
...
from electrum_tls.plugin import Device, runs_in_hwd_thread
...
from electrum_tls.plugins.hw_wallet import HW_PluginBase
from electrum_tls.plugins.hw_wallet.plugin import is_any_tx_output_on_change_branch, \
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Telestai Testnet" if constants.net.TESTNET else "Telestai"
