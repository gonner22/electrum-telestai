...
Secret backup plug-in for the electrum-tls wallet.
...
from electrum_tls.util import make_dir, InvalidPassword, UserCancelled
from electrum_tls.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_tls.gui.qt.qrtextedit import ScanQRTextEdit
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_tls.gui.qt.password_dialog import PasswordDialog
