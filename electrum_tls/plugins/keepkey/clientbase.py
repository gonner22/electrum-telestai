...
from electrum_tls.util import UserCancelled
from electrum_tls.keystore import bip39_normalize_passphrase
from electrum_tls.bip32 import BIP32Node, convert_bip32_strpath_to_intpath
from electrum_tls.logging import Logger
from electrum_tls.plugin import runs_in_hwd_thread
from electrum_tls.plugins.hw_wallet.plugin import HardwareClientBase, HardwareHandlerBase
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the telestais in the wallet.").format(self.device)
        else:
...
class KeepKeyClientBase(HardwareClientBase, GuiMixin, Logger):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("electrum-tls pinging device")
            assert res == "electrum-tls pinging device"
