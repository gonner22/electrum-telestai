...
from electrum_tls.gui.qt.util import WaitingDialog, EnterButton, WindowModalDialog, read_QIcon
from electrum_tls.i18n import _
from electrum_tls.logging import get_logger

if TYPE_CHECKING:
    from electrum_tls.gui.qt.transaction_dialog import TxDialog
