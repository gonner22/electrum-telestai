...
from electrum_tls.transaction import Transaction
...
from electrum_tls.plugins.hw_wallet import HW_PluginBase, HardwareClientBase
from electrum_tls.plugins.hw_wallet.plugin import OutdatedHwFirmwareException
