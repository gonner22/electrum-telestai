#
# Coldcard Electrum-TLS plugin main code.
#
#
import os
import time
...
from electrum_tls.bip32 import BIP32Node, InvalidMasterKeyVersionBytes
from electrum_tls.i18n import _
from electrum_tls.plugin import Device, hook, runs_in_hwd_thread
from electrum_tls.keystore import Hardware_KeyStore, KeyStoreWithMPK
from electrum_tls.transaction import PartialTransaction
from electrum_tls.wallet import Standard_Wallet, Multisig_Wallet, Abstract_Wallet
...
class CKCCClient(HardwareClientBase):
    ...
    def ping_check(self):
        ...
        req = b'1234 Electrum-TLS Plugin 4321'      # free up to 59 bytes
        try:
...
class Coldcard_KeyStore(Hardware_KeyStore):
    ...
    def sign_message(self, sequence, message, password, *, script_type=None):
        ...
        try:
            ...
            # already encoded in Telestai fashion, binary.
    ...
    def _encode_txin_type(txin_type):
        # Map from Electrum-TLS code names to our code numbers.
...
class ColdcardPlugin(HW_PluginBase):
    ...
    def export_ms_wallet(wallet: Multisig_Wallet, fp, name):
        ...
        print('# Exported from Electrum-TLS', file=fp)
